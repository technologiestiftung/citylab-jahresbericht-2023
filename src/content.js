    ...
    items: [
      {
        ...
        text: {
          ...
          paragraph: {
            ...
            en: `How might it be possible for Berlin residents to get appointments at citizen centers more quickly? What would a workplace at a citizen center of the future look like? Which workflows at the citizen center vocational training department might be optimized so as to get closer to achieving the 14-day target – i.e. enabling people to get an appointment at a Berlin citizen center within 14 days? In our project Bürgeramt der Zukunft (“The Citizen Center of the Future”) project, we addressed this question and tested a prototype on site together with the citizen center vocational training department in Friedrichshain-Kreuzberg. The goal of the test phase was to test the hypothesis that an on-site check-in would help the training department be more quick and effective at identifying no-shows, thereby allowing for more flexible appointment scheduling. In addition to the very successful testing days, a quantitative and qualitative survey was conducted at the same time. The next step will be to analyze the results, which will then be made available to the citizen services management at Friedrichshain-Kreuzberg.`,
          },
        },
        img: {
