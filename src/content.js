      ...
      },
      {
        ...
        text: {
          ...
          paragraph: {
            ...
            en: "The CityLAB Summer School kicked off for the fifth time in September, this year focusing on the topics of urban noise and urban agriculture. In cooperation with HTW Berlin, the Technical University of Berlin (TU) and the developers of the “Hydrotower”, students spent the ten-day Summer School working on concrete solutions to urban challenges and developed innovative prototypes for a healthier city.<br/>This year they were given the opportunity to take on their challenges at various locations in the city so as to gain inspiration in different settings. The kick-off event took place in the open air at the <i>Kiezlabor</i>. This was followed by further stations at Junge Tüftler’s GoodLab, at CityLAB, and with the Spore Initiative, where there was plenty of room for new perspectives. Read our blog post to find out what creative solutions emerged and what the Summer School was like in an outdoor setting.",
          },
        },
        img: {
      ...
      },
      {
        ...
        text: {
          ...
          paragraph: {
            ...
            en: "Mobility data, anonymization and privacy – it’s hard to imagine public discourse on the sustainable mobility transition without these issues coming up. Thats why they’re the focus of the transdisciplinary research project freemove, funded by the Federal Ministry of Education and Research (BMBF): in this connection we’ve now spent three years working with our university and field partners investigating the possibilities of the anonymization of movement data. At the freemove symposium “Privacy & Mobility 2023”, we spent a varied, knowledge-packed day with numerous invited guests from the field at Technologiestiftung Berlin. The event was focused on presenting the findings from our work for stakeholders who face similar challenges in their day-to-day work and to engage in discussion with them.",
          },
        },
        img: {
    ...
    items: [
      {
        ...
        text: {
          ...
          paragraph: {
            ...
            en: "A festival for digital society and the largest conference of its kind in Europe, re:publica took place this year at Festsaal Kreuzberg and Arena Berlin under the motto “CASH”. In order to create a meeting space for visitors on their way to re:publica and residents of the surrounding neighborhoods, we set up the <i>Kiezlabor</i> by the entrance to re:publica so people could take part in numerous activities on the topic “What does the city cost?” (free of charge, of course!). But we were also at re:publica itself, where we contributed fascinating talks and interactive showcases on the topics of administrative digitalization, silent participation and digital citizen services of the future. Our highlight: the panel hosted by our director Dr. Benjamin Seibel on one of the main festival stages, also featuring Stephanie Kaiser, Chief Product Officer of the Federal Government’s DigitalService.",
          },
        },
        img: {
      ...
      },
      {
        ...
        text: {
          ...
          paragraph: {
            ...
            en: "Once a year, the Creative Bureaucracy Festival demonstrates just how experimental and inventive the public sector can be. It presents innovative approaches from the field as well as stimuli on how cities can become even more innovative so as to increase their sustainability and living quality – so the measures adopted under the strategy <i>Gemeinsam Digital: Berlin</i> were a must-have, of course! In addition to presenting selected projects from the <i>GD:B</i> strategy, we discussed approaches to measuring the impact of a successful smart city project – and we’re already looking forward to testing these in practice.",
          },
        },
        img: {
